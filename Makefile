#!/home/012/z/zx/zxa180005/HW3/bin/make -f                                                                                                           #                                                                                                                                                    # Filename:             Makefile                                                                                                                     # Date:                 November 25, 2020                                                                                                            # Author:               Zainab Anwar with help from Professor Stephen Perkins' MakefileExample                                                       # Email:                zxa180005@utdallas.edu                                                                                                       # Version:              1.0                                                                                                                          # Copyright:    2020, All Rights Reserved                                                                                                            #                                                                                                                                                    # Description:                                                                                                                                       #                                                                                                                                                    # A moderately complex makefile that takes care of                                                                                                   # creating dependencies                                                                                                                              #                                                                                                                                                    
